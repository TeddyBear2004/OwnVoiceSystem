                            ...
                            voiceState
                                    ...
                                    .flatMap(voiceChannel -> {
                                        try{
                                            ...
                                            return voiceChannel.edit(voiceChannelEditSpec -> voiceChannelEditSpec.setUserLimit(i))
                                                    .then(messageChannel.createMessage("The user limit was successfully updated."));
